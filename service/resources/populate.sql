...
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 01:12:10',1,2,'Message 1');
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 03:12:10',1,2,'Message 2');
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 04:22:10',2,1,'Message 3');
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 15:32:10',1,2,'Message 4');
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 17:12:10',2,1,'Message 5');
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 05:12:10',3,1,'Message 6');
insert into message (send_date,from_id,to_id,content) values ('2015-05-04 01:12:10',2,3,'Message 7');