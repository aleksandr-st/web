...
CREATE TABLE MESSAGE(
	...
	, CONTENT VARCHAR(500)
	, PRIMARY KEY (ID)
	, CONSTRAINT FK_MESSAGE_1 FOREIGN KEY (FROM_ID) REFERENCES CONTACT (ID) ON DELETE CASCADE
	, CONSTRAINT FK_MESSAGE_2 FOREIGN KEY (TO_ID) REFERENCES CONTACT (ID) ON DELETE CASCADE
);